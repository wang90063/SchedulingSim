...
- reference_config: `configs/systematic_simulation_analysis_load_ratio_rho_first_prb_cover_midband_batch_pdb050_bg070.json`
...
- Scene points evaluated: `18`
- Proposed improves `3` points, ties `12` points, and regresses `3` points.
...
- Zero-gain scene points: `12`
- Negative-gain scene points: `3`
- Best gain scene: `case=`L05` rho_bg=`0.070` rho_pdb=`0.447` prb_share_pdb=`0.865` pdb_ms=`50` pdb_packet_kb=`6.1``
- Lowest center-retention scene: `case=`L06` rho_bg=`0.070` rho_pdb=`0.454` prb_share_pdb=`0.866` pdb_ms=`50` pdb_packet_kb=`3.1``
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| critical | 6 | 0.33 | 0.50 | -0.001 | 1.000 | 0.000 |
| feasible | 12 | 0.67 | 0.00 | 0.000 | 1.000 | -0.000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| easy | 0.070 | 0.300 | 0.070 | 0.300 | 0.811 | 50 | 4.1 | 0.000 | 1.000 |
| critical | 0.070 | 0.450 | 0.070 | 0.447 | 0.865 | 50 | 6.1 | 0.002 | 1.000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| easy | 1.000 | 1.000 | 17.4 | 17.4 | 20.6 | 20.6 | 4710400.0 | 4710400.0 | 1.000 |
| critical | 0.854 | 0.855 | 19.8 | 19.8 | 23.8 | 23.8 | 4708389.4 | 4708064.1 | 1.000 |

## Summary

- Proposed improves `3/18` load-ratio scene points; best gain is `0.002`.
