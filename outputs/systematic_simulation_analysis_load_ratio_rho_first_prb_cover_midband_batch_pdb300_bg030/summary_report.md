...
- reference_config: `configs/systematic_simulation_analysis_load_ratio_rho_first_prb_cover_midband_batch_pdb300_bg030.json`
...
- Best gain scene: `case=`L01` rho_bg=`0.030` rho_pdb=`0.300` prb_share_pdb=`0.909` pdb_ms=`300` pdb_packet_kb=`24.6``
- Lowest center-retention scene: `case=`L01` rho_bg=`0.030` rho_pdb=`0.300` prb_share_pdb=`0.909` pdb_ms=`300` pdb_packet_kb=`24.6``
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| easy | 0.030 | 0.300 | 0.030 | 0.300 | 0.909 | 300 | 24.6 | 0.000 | 1.000 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| easy | 1.000 | 1.000 | 32.4 | 32.4 | 43.0 | 43.0 | 2048000.0 | 2048000.0 | 1.000 |
